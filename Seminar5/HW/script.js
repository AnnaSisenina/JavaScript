...
const productsWithPhoto = products2.filter((product) => {
...
const sortedProducts2 = products2.sort((product1, product2) => product1.price - product2.price);
